...
-- @rationale
-- An improvement over using `ngx.ctx` as of today considering
-- this value is namespaced for plugins only (no possible conflicts with the core
-- per-request `ctx`). It also bears a more intuitive name that hints this behavior.
-- @usage
