...
local function new(self)
  ...
  -- @rationale
  -- returns the value of the Nginx variable `$realip_remote_addr`
  -- if it is defined, and `$remote_addr` if not.
  ...
  -- @phases `certificate`, `rewrite`, `access`, `header_filter`, `body_filter`, `log`
  -- @rationale returns the value of the Nginx variable `$remote_addr`.
  -- @treturn string ip The remote address of the client making the request, considering forwarded addresses
  -- @usage
  -- -- Given a client with IP 127.0.0.1 making connection through
  -- -- a load balancer with IP 10.0.0.1 to Kong answering the request for
  ...
  -- @phases `certificate`, `rewrite`, `access`, `header_filter`, `body_filter`, `log`
  -- @rationale
  -- returns the value of the Nginx variable `$realip_remote_port`
  -- if it is defined, and `$remote_port` if not.
  ...
  -- @phases `certificate`, `rewrite`, `access`, `header_filter`, `body_filter`, `log`
  -- @rationale returns the value of the Nginx variable `$remote_port`.
